...
$filter = true;//Component to search by keyword
...
$fields = array('id', 'page', 'banner', 'title', 'position', 'status', 'description');
$value = array();
$type = array();
...
$type['description'] = 'textarea'; $tinymce['description']=false;  $labelFullRow['description']=false; $height['description'] = '100px;'; $width['description'] = '100%;'; 
...
$type['page'] = 'select'; $option['page'] = array();
$results = sql_read('select * from pages where status=1 order by position ASC');
$option['page']['pre-home'] = 'Home';
$option['page']['pre-report'] = 'Report';
$option['page']['pre-gallery'] = 'Gallery';
foreach((array)$results as $a){
	$option['page']['freeformat-'.$a['title']] = ucwords($a['title']);
}
...
*/
$cols = $items =array();
$cols = array('Banner' => '4', 'Title' => '2', 'Description' => '4', 'Position' => '2');//Column title and width
