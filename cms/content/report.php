...
$fields = array('id', 'photo', 'caption', 'attachment', 'position', 'status');
$value = array();
$type = array();
...
$type['attachment'] = 'pdf';
$uniqid['attachment'] = 'false';//Use Original File's name
$type['hyperlink'] = 'url';
$type['photo'] = 'image';
$type['report_content'] = 'textarea'; $tinymce['report_content']=false;  $labelFullRow['report_content']=true; $height['report_content'] = '250px;'; $width['report_content'] = '100%;';
...
*/
$cols = $items =array();
$cols = array('Photo' => '2', 'Caption' => '3', 'Attachment' => '3', 'Position' => '4');//Column title and width
