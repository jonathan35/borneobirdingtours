...
$fields = array('id', 'category',  'photo', 'position', 'status', 'seo_keyword', 'seo_description');
$value = array();
$type = array();
...
*/
$cols = $items =array();
$cols = array('Photo' => 2, 'Category' => 3, 'SEO Keyword' => 3, 'SEO Description' => 3, 'Position' => 2);//Column title and width
