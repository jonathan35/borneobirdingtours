...
if($_SESSION['validation']=='YES'){
	...
	header("Category:../authentication/login.php");
}
...
$keywordFields=array('sub_category');
$filter = true;
...
$fields = array('id', 'category', 'sub_category', 'position', 'status');//, 'photo'
$value = array();
$type = array();
...
*/
$cols = $items =array();
$cols = array('Category' => '4', 'Sub Category' => '6', 'Position' => '2');//Column title and width
$items['Category'] = array('category');
//$items['Photo'] = array('photo');
$items['Sub Category'] = array('sub_category');//, 'Photo' => '2'
