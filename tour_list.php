        ...
        <div class="col-12 col-md-4 p-4 page page<?php echo $itemCount?>" style="<?php if($itemCount>$maxPerPage){?> display:none;<?php }?>">
            ...
            <div class="row">
                <div class="col-12 tour-card">
                    <div class="row">
                        <div class="col-12 p-0 bg-cover" style="height:200px; background-image:url('<?php if(file_exists($tour['photo'])){?>
                            <?php echo ROOT.$tour['photo']?>
                        <?php }else{?>
                            <?php echo ROOT.'images/SD-default-image.png'?>
                        <?php }?>')">
                        </div>
                        <div class="col-12">
                            <div class="row">
